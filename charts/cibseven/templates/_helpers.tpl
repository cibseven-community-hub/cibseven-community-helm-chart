...
{{ if or (eq (include "cibseven.h2DatabaseIsUsed" .) "true") (not (empty .Values.extraVolumeMounts)) (not (empty .Values.extraVolumes)) (not (empty .Values.distro.applicationYaml)) -}}
true
{{- else -}}
false
{{- end }}
